...
<section class="page-intro">
  <h2>Phase 9 — Training Dynamics</h2>
  <p><strong>Question:</strong> Does the model exhibit grokking — a sudden phase transition from memorization to generalization?</p>
  <p><strong>Method:</strong> Save checkpoints every epoch for 30 epochs; track per-distance val accuracy, per-layer probe MAE, and per-component DLA across training time.</p>
  <p><strong>Finding:</strong> No sharp phase transition. Accuracy builds gradually; mlp_0 DLA grows monotonically. Consistent with incremental learning rather than a grokking-style sudden generalization.</p>
</section>"""
