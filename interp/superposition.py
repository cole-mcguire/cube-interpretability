...
<section class="page-intro">
  <h2>Phase 11 — Superposition Analysis</h2>
  <p><strong>Question:</strong> Does the model encode more features than its 128-dimensional residual stream can orthogonally represent?</p>
  <p><strong>Method:</strong> Train sparse autoencoders at expansion ratios 1×–16× on each residual-stream layer; track reconstruction R², active feature count, and dead-feature fraction.</p>
  <p><strong>Finding:</strong> R² exceeds 0.999 at 1× expansion for most layers. No dead-feature spike and no active-count plateau. This model does not exhibit classical superposition.</p>
</section>"""
