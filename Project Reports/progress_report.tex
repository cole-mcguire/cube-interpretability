...
\begin{enumerate}
  ...
  \item \textbf{Scope of the text representation work.}  Should the text
        representation experiments be framed as a central contribution (motivating
        a shift toward interpretability of pretrained LLMs) or as a methodological
        validation (confirming that piece\_identity is a sufficient representation
        before using it as an input encoding)?  Concretely: does the instructor
        see the from-scratch interpretability (Phases 4--5) as the main story, with
        the text rep work as context, or the reverse?
